...
#Level1
execute at @a[scores={small_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:copper_ingot"}],SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}}] if score number RNG_77 matches 0..1024 run tellraw @p[tag=shield] {"text":"<Smelt> Successfully Smelted Item!","bold":true,"color":"#26FF43","hoverEvent":{"action":"show_text","contents":[{"text":"+1 smelt level","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={small_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:copper_ingot"}],SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}}] if score number RNG_77 matches 0..1024 run scoreboard players add @p small_smelt 1
execute at @a[scores={small_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:copper_ingot"}],SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}}] if score number RNG_77 matches 0..1024 run scoreboard players add @p shield-small 1
execute at @a[scores={small_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:copper_ingot"}],SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}}] if score number RNG_77 matches 1025..2048 run tellraw @p[tag=shield] {"text":"<Smelt> Item Smelt Failed!","bold":true,"color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"+0 enchantment level","italic":true,"color":"dark_purple"}]}}
execute at @a[scores={small_smelt=0,smelt=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:copper_ingot"}],SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}}] if score number RNG_77 matches 1025..2048 run scoreboard players set @p small_smelt 0
#================================================================================================================
