...
execute at @a[tag=shield,scores={carrotbreak=1..}] if score number RNG_77 matches 0..7 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Carrot","color":"#dd7327","bold":true}',Item:{id:"minecraft:carrot",Count:2b}}
