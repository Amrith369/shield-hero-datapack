...
execute at @s if score number RNG_77 matches 1..6 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Diamond","color":"#93ffff","bold":true}',Item:{id:"minecraft:diamond",Count:2b}}
