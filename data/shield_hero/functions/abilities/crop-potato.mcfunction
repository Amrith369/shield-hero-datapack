...
execute at @a[tag=shield,scores={potatobreak=1..}] if score number RNG_77 matches 7 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Potato","color":"#ddb027","bold":true}',Item:{id:"minecraft:potato",Count:1b}}
