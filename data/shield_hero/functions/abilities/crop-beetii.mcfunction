...
execute at @a[tag=shield,scores={beetbreak=1..}] if score number RNG_77 matches 0..7 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Beetroot","color":"#5e152d","bold":true}',Item:{id:"minecraft:beetroot",Count:2b}}
