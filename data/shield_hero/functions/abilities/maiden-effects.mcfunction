...
execute at @s[scores={maiden=30}] run effect give @e[distance=0..2,type=!#shield_hero:undead] instant_damage 1 4 true
execute at @s[scores={maiden=30}] run effect give @e[distance=0..2,type=#shield_hero:undead] instant_health 1 4 true
