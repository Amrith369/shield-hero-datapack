...
execute at @a[tag=shield,scores={wheatbreak=1..}] if score number RNG_77 matches 7 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Wheat","color":"#ddb027","bold":true}',Item:{id:"minecraft:wheat",Count:1b}}
