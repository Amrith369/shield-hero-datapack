...
execute at @a[tag=shield,scores={netherbreak=1..}] if score number RNG_77 matches 7 run summon item ^ ^1 ^3 {CustomNameVisible:1b,CustomName:'{"text":"Ancient Debris","color":"#47080c","bold":true}',Item:{id:"minecraft:ancient_debris",Count:1b}}
