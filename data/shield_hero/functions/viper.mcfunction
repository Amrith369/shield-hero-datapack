...
execute at @a[scores={block=1..},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369008}}}] run execute anchored eyes run summon evoker_fangs ^-0.5 ^ ^1.2 {Tags:["viperfang"]}
execute at @e[tag=viperfang] run effect give @e[distance=0..1] poison 600 3
effect clear @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369008}}}] poison
#Proficiency
