execute at @a[tag=shield,x_rotation=-90..-60,scores={ass=1..,sp=40..},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369005}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:2f,Duration:300,Age:0,Particle:"underwater",Tags:["sp"]}
execute at @a[tag=shield,x_rotation=-59..45,scores={ass=1..,sp=40..},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369005}}}] run summon minecraft:area_effect_cloud ^ ^1 ^5 {Radius:2f,Duration:300,Age:0,Particle:"underwater",Tags:["sp"]}
execute at @a[tag=cage,x_rotation=-59..30,scores={ass=1..,sp=40..},nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}]}] run summon minecraft:area_effect_cloud ^ ^1 ^5 {Radius:2f,Duration:300,Age:0,Particle:"underwater",Tags:["sp"]}
execute at @a[tag=cage,x_rotation=-90..-60,scores={ass=1..,sp=40..},nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b,tag:{CustomModelData:369001}}]}] run summon minecraft:area_effect_cloud ^ ^ ^ {Radius:2f,Duration:300,Age:0,Particle:"underwater",Tags:["sp"]}
