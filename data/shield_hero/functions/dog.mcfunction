...
execute at @a[scores={block=1..,dogprof=..500},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369007}}}] run execute at @e[distance=1..3,type=!item,tag=!shield-party] run summon evoker_fangs ~ ~ ~
execute at @a[scores={block=1..,dogprof=500..},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369007}}}] run execute at @e[distance=1..5,type=!item,tag=!shield-party] run summon evoker_fangs ~ ~ ~
execute at @a[scores={block=1..,dogprof=500..},nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{CustomModelData:369007}}}] run execute at @e[distance=2..6,type=!item,tag=!shield-party] run summon evoker_fangs ~ ~ ~
